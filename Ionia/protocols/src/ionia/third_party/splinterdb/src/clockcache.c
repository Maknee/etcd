                       ...
                       uint64             use_stats)
{
   ...
   cache_cfg->use_stats     = 1;

   printf("during config init, use_stats = %d ============================ \n", cache_cfg->use_stats);
...
clockcache_print(platform_log_handle *log_handle, clockcache *cc)
{
   ...
   for (i = 0; i < cc->cfg->page_capacity; i++) {
      ...
      printf( "0x%02x-%u ", status, refcount);
   }
...
clockcache_print_stats(platform_log_handle *log_handle, clockcache *cc)
{
   ...
   printf( "-----------------------------------------------------------------------------------------------\n");
   printf( "page type       |      trunk |     branch |   memtable |     filter |        log |       misc |\n");
   printf( "----------------|------------|------------|------------|------------|------------|------------|\n");
   printf( "cache hits      | %10lu | %10lu | %10lu | %10lu | %10lu | %10lu |\n",
   ...
   printf( "cache misses    | %10lu | %10lu | %10lu | %10lu | %10lu | %10lu |\n",
   ...
   printf( "cache miss time | " FRACTION_FMT(9, 2)"s | "
   ...
   printf( "pages written   | %10lu | %10lu | %10lu | %10lu | %10lu | %10lu |\n",
   ...
   printf( "pages read      | %10lu | %10lu | %10lu | %10lu | %10lu | %10lu |\n",
   ...
   printf( "avg prefetch pg |  " FRACTION_FMT(9, 2)" |  "
   ...
   printf( "-----------------------------------------------------------------------------------------------\n");
   printf( "avg write pgs: "FRACTION_FMT(9,2)"\n",
