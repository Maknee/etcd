...
{
   platform_default_log("=================creating splinterdb============ \n");
...
{
   splinterdb_stats_print_cache(*kvs_in);
...
void
splinterdb_stats_print_cache(splinterdb *kvs)
{
   kvs->spl->cc->ops->print_stats(Platform_default_log_handle, kvs->spl->cc);
}
